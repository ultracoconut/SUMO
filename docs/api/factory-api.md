...
| Function | Inputs | Outputs | Permissions | Description |
|---------|--------|---------|-------------|-------------|
| MAX_DURATION | — | `uint256` | Anyone | Maximum allowed default subscription duration (system limit). |
| MAX_SECONDARY_ACCOUNTS | — | `uint256` | Anyone | Maximum allowed secondary accounts per subscription (system limit). |
